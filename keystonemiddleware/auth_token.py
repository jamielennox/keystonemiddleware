    ...
    def _identity_server(self):
        if not self._identity_server_obj:
            ...
            if auth_version == 'v3.0':
                ...
                for auth_version, klass in VERSIONS_TO_ATTEMPT:
                    if adap.get_endpoint(version=auth_version):
...
VERSIONS_TO_ATTEMPT = [((3, 0), _V3IdentityServer),
                       ((2, 0), _V2IdentityServer)]
